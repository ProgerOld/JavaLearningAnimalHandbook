...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setInitialData(); // инициализируем контейнер
        RecyclerView recyclerView = findViewById(R.id.list_animal); // создадим объект RecyclerView и привяжем к нему соответствующий id
